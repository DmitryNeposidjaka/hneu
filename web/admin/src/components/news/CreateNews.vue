...
<script>
    import FormArticle from './CreateArticle'
    import FormAdvertising from './CreateAdvertising'
    import FormMessage from './CreateMessage'

    export default {
        props: ['type', 'categories', 'languages'],
