...
<main class="cd-main-content">
    <div class="page-header header-filter header-small" data-parallax="true" style="background-image: url('assets/img/section-bg-2.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto text-center">
                    <h2 class="title">Магазин фирменной символики ХНЭУ</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-shopping">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="text-right">
                                    ...
                                    <button class="btn btn-rose btn-block btn-round" data-toggle="modal" data-target="#loginModal">
                                        <i class="material-icons">account_circle</i> Buy Now
        ...
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <div class="modal-footer justify-content-center">
                    <!--            <a href="#pablo" class="btn btn-primary btn-link btn-wd btn-lg">To order</a>-->
                    <button type="button" class="btn btn-primary btn-link btn-wd btn-lg" data-dismiss="modal" aria-hidden="true">To order</button>
                </div>
            </div>
        </div>
    </div>
